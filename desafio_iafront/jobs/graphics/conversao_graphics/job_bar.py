...
from desafio_iafront.jobs.graphics.conversao_graphics.utils import bar
from desafio_iafront.data.dataframe_utils import read_partitioned_json
from desafio_iafront.jobs.common import filter_date


@click.command()
@click.option('--dataframe-path', type=click.Path(exists=True), help="Path of data with clusters")
